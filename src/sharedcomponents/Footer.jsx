        ...
        <div className="row">
          <div className=" col">
            <h1 className="flex items-center">
              <img
                src=" https://i.ibb.co/pwm3CW1/416449616-351255101191909-731095575509226543-n-1.png"
                className=" w-[40%] h-[40%] "
              />
          ...
          <div className="col">
            ...
            <div className="socal-icone flex gap-4 text-2xl  ">
              <Link to={"https://www.facebook.com/hridayray.hriday.1/"}>
                {" "}
                <ImFacebook className="  hover:bg-orange-500  "></ImFacebook>{" "}
              </Link>
              <Link to={"https://www.instagram.com/hridayrayhriday/"}>
                {" "}
                <FaInstagramSquare className="  hover:bg-orange-500  "></FaInstagramSquare>{" "}
              </Link>
              <Link to={"https://github.com/hridayroy19"}>
                <FaGithub className="  hover:bg-orange-500  "> </FaGithub>{" "}
              </Link>
