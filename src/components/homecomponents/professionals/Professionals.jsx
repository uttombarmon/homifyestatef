...
const Professionals = () => {
  return (
    <>
      ...
      <div className="grid justify-center mx-auto md:grid-cols-2 grid-cols-1 lg:grid-cols-4 lg:w-[1250px] md:w-[650px] gap-2">
        <div className="card w-[300px] mt-7 ml-7 bg-white border">
          <div className="group w-full  h-full relative border-slate-500 overflow-hidden">
            <img
              src="https://i.ibb.co/Yh6KSBk/images-2.jpg"
              alt=""
              className="w-full h-full"/>
            <div className="absolute top-0 right-full w-full h-full group-hover:right-0 bg-[#29404788] backdrop-blur-[5px]  p-7 flex flex-col justify-center ">
