    ...
    <>
      <div className=" w-full py-10 ">
        <div className=" md:flex md:justify-between px-2 mb-4">
          ...
          {/* explore button  */}
          <Link to={'/properties'} data-aos="fade-left" data-aos-duration="1000" className=" btn self-start md:self-center border-[1px] my-6 md:my-0 border-amber-200 bg-transparent rounded-3xl font-bold"> More Explore <FaExternalLinkAlt></FaExternalLinkAlt></Link>
        </div>
